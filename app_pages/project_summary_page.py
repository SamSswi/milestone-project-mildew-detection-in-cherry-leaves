...
# The design of this dashboard page is inspired by the Quick Project
# Summary page From the Code Institute Malaria Detector sample project.
# https://malaria-predictor.onrender.com/


def project_summary_page_body():
    """
    Displays the project summary page of the
    ...
    st.info(
        ...
        'including sweet cherries (Prunus avium) and sour '
        'cherries (Prunus cerasus). \n'
        '* On leaves, powdery mildew appears as patches of white, powdery '
        'or felt-like fungal growth. Severely affected leaves and shoots '
    ...
    st.success(
        ...
        'leaf is healthy or contains powdery mildew.\n')
