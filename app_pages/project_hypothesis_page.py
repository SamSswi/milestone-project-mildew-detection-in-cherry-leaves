...
def project_hypothesis_body():
    ...
    st.success(
        '* Hypothesis 1: There are visible patterns in the cherry leaf '
    ...
    st.success(
        '* Hypothesis 2: Neural Networks can effectively map the '
        ...
        'has an accuracy of 99.88% on the unseen data from the test '
        'set.\n'
    )

    st.success(
        "* Hypothesis 3: Reducing the image shape to smaller dimensions "
    ...
    st.success(
        ...
        'test dataset, the accuracy of the model was 99.88%. These metrics '
