...
# The design of this dashboard page is inspired by the Malaria Detection page
# From the Code Institute Malaria Detector sample project.
# https://malaria-predictor.onrender.com/


# the plot_predictions_probabilities function was taken from Code Institute
# Malaria Detector Sample Project
...
# the resize_input_image function was taken from Code Institute Malaria
# Detector Sample Project
# https://github.com/Code-Institute-Solutions/WalkthroughProject01/blob/main/src/machine_learning/predictive_analysis.py
def resize_input_image(img, version):
    ...
    image_shape = image_shape = joblib.load(
        filename=f"outputs/{version}/image_shape.pkl")
...
# the load_model_and_predict function was taken from Code Institute Malaria
# Detector Sample Project
# https://github.com/Code-Institute-Solutions/WalkthroughProject01/blob/main/src/machine_learning/predictive_analysis.py
def load_model_and_predict(my_image, version):
    ...
    st.write(
        f"The predictive analysis diagnosis "
        f"for the leaf sample: **{pred_class.lower()}**")

    return pred_proba, pred_class


# the download_dataframe_as_csv function was taken from Code Institute
# Malaria Detector Sample Project
...
def powdery_mildew_detection_body():
    """
    Displays the mildew detection page of the
    ...
    # the idea to use the 'st.file_uploader' function was
    # taken from streamlit documentation
    # https://docs.streamlit.io/library/api-reference/widgets/st.file_uploader
    uploaded_files = st.file_uploader(
        "Upload leaf samples. You may select more than one.",
        accept_multiple_files=True, type=['jpg'])

    # The following if statement was adapted from Code Institute's
    # Malaria Detection Sample Project
