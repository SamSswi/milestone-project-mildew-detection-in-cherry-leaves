# The code for this file was adapted from Code Institute
# Malaria Detection Project Dashboard
...
app.add_page(title='Cherry Leaves Visualizer', func=leaves_visualizer_body)
